...
urlpatterns = [
    ...
    path('fetch_dependent_options/', views.fetch_dependent_options,
         name='fetch_dependent_options'),
    ...
    path('edit_client1/<int:id>', views.edit_client1),
    path('admin-campaign-view/<int:id>',
         views.superadmin_campaign_dashboard_view)
